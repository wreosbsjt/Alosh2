...
async def join_channel():
    try:
        await sedthon(JoinChannelRequest("@f6f7f"))
...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.تليثون"))
async def _(event):
    await event.edit(commands)
...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.8"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec8)
    
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.9"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec9)

@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.0"))
async def _(event):
    start = datetime.datetime.now()
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('أهلاً بك مطوري - @f6f7f')
...
async def _(event):
    ...
    await event.edit("يتم ..")
    animation_chars = [
        "اضغط للنسخ وقم بلرد علا الذاتيه لحفضها ** .ذاتيه ** للرجوع ارسل .الاوامر",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await event.edit(animation_chars[i % 17])
...
###############هنا نبدي اوامر اختراق عبر كود تيريمكس من حسابك #############
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.A"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
    await event.edit("يتم ..")
    animation_chars = [
        "عليك ارسال جلسة بايروجرام او تيرميكس بين قوسين () ",
...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.b"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.C"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.D"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.E"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.F"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.G"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.H"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.I"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.K"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.L"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
...
@sedthon.on(events.NewMessage(outgoing=True, pattern=r"\.م00"))
async def _(event):
    event = await event.edit("حسناً")
    animation_interval = 0.2
    animation_ttl = range(96)
    await event.edit("يتم ..")
    animation_chars = [
        " ارسل حرف (.W) لتغيير رقم حشاب شخص لرقمك  ",

###############هنا ننتهي من الاوامر السويتها جديده ختراق تيرميكس #############
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await event.edit(animation_chars[i % 17])
...
async def _(event):
    ...
    animation_chars = [
        ...
        " هاذا القسم مدفوع  وليس مجاني ولقد اكتشفت انك لم تقم بالاشتراك 😢 للاشتراك تواصل مع مطور السورس @f6f7f ",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await event.edit(animation_chars[i % 17])
...
async def _(event):
    ...
    animation_chars = [
        ...
        "6🔆",
        "تم التحقق من انك لست روبوت 🤖✅."
        "خطـوات تنصـيب استاثون او نشر تلقائي مجانـا 🥷  ✺ | اقرء الشروط : https://t.me/f6f7f  ✺ |  عند التنصيب انت تتحمل مسئولية حسابك ومسئولية تنصيب لانتحمل أي مسئولية هذا فقط سورس مجاني نشاركة معكم لاأكثر  ✺ | والان يمكنك الذهاب لتنصيب السورس https://t.me/f6f7f ",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await event.edit(animation_chars[i % 17])
